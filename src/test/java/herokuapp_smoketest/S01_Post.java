...
*/
    ...
    public void name() {
       ...
       Response response= given().spec(spec).when().body(expectedData).post("{first}");
        ...
        assertEquals(expectedData.getFirstname(),actualData.getBooking().getFirstname());//booking in icinden firstname e ulasiyoruz

        assertEquals(expectedData.getLastname(),actualData.getBooking().getLastname());
        assertEquals(expectedData.getTotalprice(),actualData.getBooking().getTotalprice());
        assertEquals(expectedData.getDepositpaid(),actualData.getBooking().getDepositpaid());
        assertEquals(bookingDatesPojo.getCheckin(),actualData.getBooking().getBookingdates().getCheckin());//normalde  expectedData.getBookingdates().getCheckin() yapardik dahA KISA OLsun diye bookingdatepojodan aliyorum
