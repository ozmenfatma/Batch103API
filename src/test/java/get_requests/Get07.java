...
//grovy rest Assured ile geliyor
    ...
    */
    ...
    public void get07(){
        ...
        List<Object> list = jsonPath.getList("findAll{it.id>190}.userId");//Groovy Language Java temelli bir programlama dilidir,baska bir dil oldugu icin JS EXecutor gibi tirnak icine aliyoruz
